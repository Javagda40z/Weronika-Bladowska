...
class ProductServiceTest {
    ...
    void setUp() {
        ...
        Product product=new Product("jablko", 50,1,ProductType.OWOCE);
        Product product1=new Product("gruszka", 50,1,ProductType.OWOCE);
        Product product2=new Product("kurczak", 50,1,ProductType.MIESO);
        Product product3=new Product("marchewka", 50,1,ProductType.WARZYWA);
